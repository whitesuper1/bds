            ...
            r.options.functionBefore.call(r.$el, r.$el, function() {
                if (r.enabled && r.Content !== null) {
                    ...
                    if (r.Status !== "hidden") {
                        ...
                        r.$tooltip = e('<div class="tooltipster-base ' + r.options.theme + '" style="'+BaseStyle+'"><div class="tooltipster-content" style="'+contentStyle+'"></div></div>');
                        /*r.$tooltip = e('<div class="tooltipster-base ' + r.options.theme + '" style="' + ultCW + " " + f + " " + c + " " + h + " " + a + '"><div class="tooltipster-content" style="'+ultSize+'"></div></div>');*/
