...
<div class="adv-search-1 <?php echo $close_class.' '.$extended_class;?>" id="adv-search-1" data-postid="<?php echo $post_id; ?>"> 
    ...
    <form role="search" method="get"   action="<?php print $adv_submit; ?>" >
        ...
        <div class="dropdown form-control" >
            ...
            <input type="hidden" name="filter_search_action[]" value="<?php if(isset($_GET['filter_search_action'][0])){echo strtolower( $_GET['filter_search_action'][0] );}?>">
        ...
        <div class="dropdown form-control" >
            <div data-toggle="dropdown" id="adv_categ" class="filter_menu_trigger" data-value="<?php echo strtolower( $adv_categ_value1);?>"> 
                ...
                ?> 
            <span class="caret caret_filter"></span> </div>           
            <input type="hidden" name="filter_search_type[]" value="<?php if(isset($_GET['filter_search_type'][0])){echo strtolower ( $_GET['filter_search_type'][0] );}?>">
        ...
        <div class="dropdown form-control" >
            <div data-toggle="dropdown" id="advanced_city" class="filter_menu_trigger" data-value="<?php echo strtolower($advanced_city_value1); ?>"> 
                ...
                ?> 
                <span class="caret caret_filter"></span> </div>           
            <input type="hidden" name="advanced_city" value="<?php if(isset($_GET['advanced_city'])){echo strtolower ( $_GET['advanced_city']);}?>">
        ...
        <div class="dropdown form-control" >
            <div data-toggle="dropdown" id="advanced_area" class="filter_menu_trigger" data-value="<?php echo strtolower( $advanced_area_value1);?>">
                <?php 
                echo $advanced_area_value;
                ?>
                <span class="caret caret_filter"></span> </div>           
            <input type="hidden" name="advanced_area" value="<?php if(isset($_GET['advanced_area'])){echo strtolower( $_GET['advanced_area']);}?>">
